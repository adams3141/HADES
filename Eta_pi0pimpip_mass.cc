...
//
  ...
  //
    ...
    TH1F* hM3g_pi0=new TH1F("hM3g_pi0","hM3g_pi0; M_{3#gamma} [MeV/c^{2}]",1000,0,2000);
    TH1F* hM3g_pi0MixS=new TH1F("hM3g_pi0MixS","hM3g_pi0MixS; M_{3#gamma} [MeV/c^{2}]",1000,0,2000);

    TH1F* hMpi0g_Mix=new TH1F("hMpi0g_Mix","hMpi0g_Mix; M_{#pi^{2}#gamma} [MeV/c^{2}]",1000,0,2000);
    
    TH1F *hMppi0_PT2=new TH1F("hMppi0_PT2","hMppi0_PT2; M_{p#pi^{0}} [MeV/c^{2}]",2000,1000,3000);
    TH1F *hMppi0_PT3=new TH1F("hMppi0_PT3","hMppi0_PT3; M_{p#pi^{0}} [MeV/c^{2}]",2000,1000,3000);
    TH1F *hMppi0_Mix=new TH1F("hMppi0_Mix","hMppi0_Mix; M_{p#pi^{0}} [MeV/c^{2}]",2000,1000,3000);
    TH1F *hMMppi0=new TH1F("hMMppi0","hMMppi0; MM_{p#pi^{0}} [MeV/c^{2}]",1000,0,3000);
    TH1F *hMM2ppi0=new TH1F("hMM2ppi0","hMM2ppi0; MM^{2}_{p#pi^{0}} GeV^{2}/c^{4}]",1200,-6.,6);
    TH1F *hMM2ppi0_Mix=new TH1F("hMM2ppi0_Mix","hMM2ppi0_Mix; MM^{2}_{p#pi^{0}} GeV^{2}/c^{4}]",1200,-6.,6);

    TH1F* hMpippimpi0_PT2=new TH1F("hMpippimpi0_PT2","hMpippimpi0_PT2; M_{#pi^{+}#pi^{-}#pi^{0}} [MeV/c^{2}]",2000,0,2000);
    TH1F* hMpippimpi0_PT3=new TH1F("hMpippimpi0_PT3","hMpippimpi0_PT3; M_{#pi^{+}#pi^{-}#pi^{0}} [MeV/c^{2}]",2000,0,2000);
    ...
    TH1F* hMpippimpi0_Mix =new TH1F("hMpippimpi0_Mix","hMpippimpi0_Mix; M_{#pi^{+}#pi^{-}#pi^{0}} [MeV/c^{2}]",2000,0,2000);    TH1F* hMggpippim_Mix =new TH1F("hMggpippim_Mix","hMggpippim_Mix; M_{#gamma#gamma#pi^{+}#pi^{-}} [MeV/c^{2}]",2000,0,2000);   
...
//PULLS
 TH1F * hPullEInvPhoton1Conv_mass_mix= new TH1F("Pull_E_photon_1_mix","Photon pull 1/E",5000,-100,100);
    ...
    TH1F * hmassPi0AfterRefit= new TH1F("hmassPi0AfterRefit","hmassPi0AfterRefit",2000000,100,2000);
    ...
    TH1F * hmassPi0BeforeRefit_selection= new TH1F("hmassPi0BeforeRefit_selection","hmassPi0BeforeRefit_selection",2000000,100,2000);
    TH1F * hmassPi0BeforeRefit= new TH1F("hmassPi0BeforeRefit","hmassPi0BeforeRefit",2000000,0,2000);
    ...
    TH1F * hphiPi0BeforeRefit= new TH1F("hphiPi0BeforeRefit","hEphiPi0BeforeRefit",1000,-180,180);
    //Residuals
    ...
    TH1F * hmassPi0AfterRefit_GEANT= new TH1F("hmassPi0AfterRefit_GEANT","hmassPi0AfterRefit_GEANT",2000000,100,2000);
		...
		for (int jj=0;jj<lv_neutr1.size();jj++){
		  ...
		  //************** pi0 ************************
		   ...
		   if (trigbit==1) hinvM_gg_PT3->Fill(mass_gg);
			 ...
			 if (trigbit==0) hMppi0_PT2->Fill(lv3.M());
			 if (trigbit==1){
			   hMppi0_PT3->Fill(lv3.M());
			   hMMppi0->Fill(lv3a.M());
			   hMM2ppi0->Fill(lv3a.M2()*1e-6);
		   ...
		   //**************** pip-pim-pi0  ********************
			 ...
			 for (int j=0;j<lv_pim.size();j++){
			   ...
			   if (trigbit==0) hMpippimpi0_PT2->Fill(lv3b.M());
			   if (trigbit==1 && Mgg>100 && Mgg<200) hMpippimpi0_PT3->Fill(lv3b.M());
                    ...
                    hthetaPi0BeforeRefit->Fill(pi0_simple.Theta()*TMath::RadToDeg());
                     total++;
                      ...
                      for(int ii_pim=0;ii_pim<lv_pim.size();ii_pim++)
                      {
                        ...
                        {
                          TLorentzVector Eta_before=pi0_simple+lv_pim[ii_pim]+lv_pip[ii_pip];
                        ...
                        if (FitterMass.getProb() > 0.25)
                        {
                          ...
                          hthetaPi0BeforeRefit_selection->Fill(pi0_simple.Theta()*TMath::RadToDeg());
                           ...
                           // cout<<lv_pim.size()<<"  "<<lv_pim.size()<<endl;
                            for(int i_pim=0;i_pim<lv_pim.size();i_pim++)
                            {
                              for(int i_pip=0;i_pip<lv_pip.size();i_pip++)
                              {
                                TLorentzVector Eta=cand1mass+cand2mass+lv_pim[i_pim]+lv_pip[i_pip];
                                TLorentzVector Eta_selection=pi0_simple+lv_pim[i_pim]+lv_pip[i_pip];
                                //cout<<Eta.M()<<"  "<<Eta.Theta()*TMath::RadToDeg()<<"  "<<Eta.Phi()*TMath::RadToDeg()<<endl;
                                Eta_m->Fill(Eta.M());
                                Eta_theta->Fill(Eta.Theta()*TMath::RadToDeg());
                                Eta_phi->Fill(Eta.Phi()*TMath::RadToDeg());

                                Eta_m_selection->Fill(Eta_selection.M());
                                Eta_theta_selection->Fill(Eta_selection.Theta()*TMath::RadToDeg());
                                Eta_phi_selection->Fill(Eta_selection.Phi()*TMath::RadToDeg());


                                for(int ii_pim=i_pim+1;ii_pim<lv_pim.size();ii_pim++)
                                {
                                  for(int ii_pip=i_pim+1;ii_pip<lv_pip.size();ii_pip++)
                                  {
                                    TLorentzVector EtaP=Eta+lv_pim[ii_pim]+lv_pip[ii_pip];
                                    //cout<<EtaP.M()<<"  "<<EtaP.Theta()*TMath::RadToDeg()<<"  "<<EtaP.Phi()*TMath::RadToDeg()<<endl;
                                    EtaP_m->Fill(EtaP.M());
...
hEPhtoton1EMC_gen->Write();
    ...
    hthetaPi0BeforeRefit_selection->Write();
